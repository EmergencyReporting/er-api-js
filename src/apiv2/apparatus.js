...
module.exports = {
    ...
    getApparatus: (departmentApparatusID, params) => (erApiGetV2WithParams(`/V2/apparatus/${departmentApparatusID}`)(params)),
    getAllApparatusCompartments: erApiGetV2WithParams('/V2/apparatus/compartments'),
    getApparatusCompartment: (compartmentID, params) => (erApiGetV2WithParams(`/V2/apparatus/compartments/${compartmentID}`)(params)),
    getAllApparatusCrews: erApiGetV2WithParams('/V2/apparatus/crews'),
    getApparatusCrews: (departmentApparatusID, params) => (erApiGetV2WithParams(`/V2/apparatus/${departmentApparatusID}/crews`)(params)),
